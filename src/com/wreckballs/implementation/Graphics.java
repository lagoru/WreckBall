...
public class Graphics implements GraphicsInterface {
    ...
    @Override
    public ImageInterface newImage(String fileName, ImageFormat format) {
        Config config = null;
    ...
    public void drawImage(ImageInterface Image, int x, int y, int srcX, int srcY,
    ...
    @Override
    public void drawScaledImage(ImageInterface Image, int x, int y, int width, int height, int srcX, int srcY, int srcWidth, int srcHeight){
